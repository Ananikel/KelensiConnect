...
export const MOCK_MEMBERS: Member[] = [
    ...
    { id: 20, name: 'Adakou Audrey KELENSI', email: 'adakou.kelensi@kelensiconnect.com', phone: '93 42 43 44', joinDate: '2021-03-15', birthDate: '1994-04-18', status: 'Actif', avatar: 'https://ui-avatars.com/api/?name=Adakou+Audrey+KELENSI&background=random', roleId: 'member', descendance: 'KELENSI', contributionTypeIds: ['cot-annuelle'] },
    ...
    { id: 23, name: 'Ayoko Popo KELENSI', email: 'ayoko.kelensi@kelensiconnect.com', phone: '97 51 52 53', joinDate: '2020-01-01', birthDate: '1984-06-28', status: 'Actif', avatar: 'https://ui-avatars.com/api/?name=Ayoko+Popo+KELENSI&background=random', roleId: 'member', descendance: 'KELENSI', contributionTypeIds: ['cot-annuelle'] },
    { id: 24, name: 'Ayoko Liliane KELENSI', email: 'ayoko.kelensi@kelensiconnect.com', phone: '91 54 55 56', joinDate: '2022-03-15', birthDate: '1996-07-19', status: 'Actif', avatar: 'https://ui-avatars.com/api/?name=Ayoko+Liliane+KELENSI&background=random', roleId: 'member', descendance: 'KELENSI', contributionTypeIds: ['cot-annuelle'] },
    { id: 25, name: 'Messan Gentil KELENSI', email: 'messan.kelensi@kelensiconnect.com', phone: '98 57 58 59', joinDate: '2021-11-20', birthDate: '1989-10-10', status: 'Actif', avatar: 'https://ui-avatars.com/api/?name=Messan+Gentil+KELENSI&background=random', roleId: 'member', descendance: 'KELENSI', contributionTypeIds: ['cot-annuelle', 'projet-ecole'] },
];
