...
export const MOCK_MEMBERS: Member[] = [
    { id: 1, name: 'Kokoè Vicentia AMOUSSOUVI', email: 'kokoe.amoussouvi@kelensiconnect.com', phone: '97 88 12 34', joinDate: '2022-03-15', birthDate: '1990-07-28', status: 'Actif', avatar: 'https://ui-avatars.com/api/?name=Kokoè+Vicentia+AMOUSSOUVI&background=random', roleId: 'secretary', descendance: 'AMOUSSOUVI', contributionTypeIds: ['cot-annuelle', 'projet-ecole'] },
    { id: 2, name: 'Assion Didier AMOUSSOUVI', email: 'assion.amoussouvi@kelensiconnect.com', phone: '91 23 45 67', joinDate: '2021-11-20', birthDate: '1985-08-05', status: 'Actif', avatar: 'https://ui-avatars.com/api/?name=Assion+Didier+AMOUSSOUVI&background=random', roleId: 'member', descendance: 'AMOUSSOUVI', contributionTypeIds: ['cot-annuelle'] },
    { id: 3, name: 'Ekoué Roméo AMOUSSOUVI', email: 'ekoue.amoussouvi@kelensiconnect.com', phone: '98 76 54 32', joinDate: '2023-01-10', birthDate: '1992-01-15', status: 'Actif', avatar: 'https://ui-avatars.com/api/?name=Ekoué+Roméo+AMOUSSOUVI&background=random', roleId: 'member', descendance: 'AMOUSSOUVI', contributionTypeIds: ['cot-annuelle', 'frais-adhesion'] },
    { id: 4, name: 'Akouété Come AMOUZOUVI', email: 'akouete.amouzouvi@kelensiconnect.com', phone: '90 11 22 33', joinDate: '2020-05-25', birthDate: '1988-11-30', status: 'Inactif', avatar: 'https://ui-avatars.com/api/?name=Akouété+Come+AMOUZOUVI&background=random', roleId: 'member', descendance: 'AMOUZOUVI', contributionTypeIds: [] },
    { id: 5, name: 'Akouètè AMOUZOUVI', email: 'akouete.amouzouvi@kelensiconnect.com', phone: '92 44 55 66', joinDate: '2022-08-01', birthDate: '1995-07-25', status: 'Actif', avatar: 'https://ui-avatars.com/api/?name=Akouètè+AMOUZOUVI&background=random', roleId: 'member', descendance: 'AMOUZOUVI', contributionTypeIds: ['cot-annuelle'] },
    { id: 6, name: 'Messan AMOUZOUVI', email: 'messan.amouzouvi@kelensiconnect.com', phone: '93 77 88 99', joinDate: '2023-02-18', birthDate: '1979-02-20', status: 'Actif', avatar: 'https://ui-avatars.com/api/?name=Messan+AMOUZOUVI&background=random', roleId: 'member', descendance: 'AMOUZOUVI', contributionTypeIds: ['cot-annuelle', 'frais-adhesion'] },
    { id: 7, name: 'Ayih Stéphane AMOUZOUVI', email: 'ayih.amouzouvi@kelensiconnect.com', phone: '99 10 20 30', joinDate: '2021-09-05', birthDate: '1991-09-10', status: 'Actif', avatar: 'https://ui-avatars.com/api/?name=Ayih+Stéphane+AMOUZOUVI&background=random', roleId: 'member', descendance: 'AMOUZOUVI', contributionTypeIds: ['cot-annuelle', 'projet-ecole'] },
    { id: 8, name: 'Dédé Daniela (Frère-vi) AMOUZOUVI', email: 'dede.amouzouvi@kelensiconnect.com', phone: '96 40 50 60', joinDate: '2020-02-20', birthDate: '2000-08-12', status: 'Actif', avatar: 'https://ui-avatars.com/api/?name=Dédé+Daniela+AMOUZOUVI&background=random', roleId: 'member', descendance: 'AMOUZOUVI', contributionTypeIds: ['cot-annuelle'] },
    { id: 9, name: 'Kokoè (Frère-vi) AMOUZOUVI', email: 'kokoe.amouzouvi@kelensiconnect.com', phone: '97 70 80 90', joinDate: '2023-05-10', birthDate: '1998-05-15', status: 'Actif', avatar: 'https://ui-avatars.com/api/?name=Kokoè+AMOUZOUVI&background=random', roleId: 'member', descendance: 'AMOUZOUVI', contributionTypeIds: ['cot-annuelle', 'frais-adhesion'] },
    { id: 10, name: 'Ayokovi (Tassi Paté-To) LAWSON', email: 'ayokovi.lawson@kelensiconnect.com', phone: '91 12 13 14', joinDate: '2021-03-15', birthDate: '1975-03-20', status: 'Inactif', avatar: 'https://ui-avatars.com/api/?name=Ayokovi+LAWSON&background=random', roleId: 'member', descendance: 'LAWSON', contributionTypeIds: [] },
    { id: 11, name: 'Adakou Kafui Romaine KELENSI', email: 'adakou.kelensi@kelensiconnect.com', phone: '98 15 16 17', joinDate: '2020-01-01', birthDate: '1980-12-25', status: 'Actif', avatar: 'https://ui-avatars.com/api/?name=Adakou+Kafui+Romaine+KELENSI&background=random', roleId: 'admin', descendance: 'KELENSI', contributionTypeIds: ['cot-annuelle', 'projet-ecole'] },
    { id: 12, name: 'Anoumou Onclo CF KELENSI', email: 'anoumou.kelensi@kelensiconnect.com', phone: '92 18 19 20', joinDate: '2023-08-01', birthDate: '1968-07-22', status: 'Actif', avatar: 'https://ui-avatars.com/api/?name=Anoumou+Onclo+CF+KELENSI&background=random', roleId: 'treasurer', descendance: 'KELENSI', contributionTypeIds: ['cot-annuelle', 'frais-adhesion'] },
    { id: 13, name: 'Messan, Doyen Famille KELENSI', email: 'messan.kelensi@kelensiconnect.com', phone: '93 21 22 23', joinDate: '2020-01-15', birthDate: '1955-01-01', status: 'Actif', avatar: 'https://ui-avatars.com/api/?name=Messan+KELENSI&background=random', roleId: 'member', descendance: 'KELENSI', contributionTypeIds: ['cot-annuelle'] },
    { id: 14, name: 'Ayih Lucien KELENSI', email: 'ayih.kelensi@kelensiconnect.com', phone: '99 24 25 26', joinDate: '2022-11-15', birthDate: '1977-11-18', status: 'Actif', avatar: 'https://ui-avatars.com/api/?name=Ayih+Lucien+KELENSI&background=random', roleId: 'member', descendance: 'KELENSI', contributionTypeIds: ['cot-annuelle'] },
    { id: 15, name: 'Amavi Isidore KELENSI', email: 'amavi.kelensi@kelensiconnect.com', phone: '96 27 28 29', joinDate: '2022-10-20', birthDate: '1982-10-25', status: 'Actif', avatar: 'https://ui-avatars.com/api/?name=Amavi+Isidore+KELENSI&background=random', roleId: 'member', descendance: 'KELENSI', contributionTypeIds: ['cot-annuelle'] },
    { id: 16, name: 'Ekoué Didier KELENSI', email: 'ekoue.kelensi@kelensiconnect.com', phone: '97 30 31 32', joinDate: '2021-08-01', birthDate: '1993-08-10', status: 'Inactif', avatar: 'https://ui-avatars.com/api/?name=Ekoué+Didier+KELENSI&background=random', roleId: 'member', descendance: 'KELENSI', contributionTypeIds: [] },
    { id: 17, name: 'Akouélé KELENSI', email: 'akouele.kelensi@kelensiconnect.com', phone: '91 33 34 35', joinDate: '2023-01-12', birthDate: '2001-01-20', status: 'Actif', avatar: 'https://ui-avatars.com/api/?name=Akouélé+KELENSI&background=random', roleId: 'member', descendance: 'KELENSI', contributionTypeIds: ['cot-annuelle', 'frais-adhesion'] },
    { id: 18, name: 'Dédé Prisca KELENSI', email: 'dede.kelensi@kelensiconnect.com', phone: '98 36 37 38', joinDate: '2020-02-20', birthDate: '1999-03-03', status: 'Actif', avatar: 'https://ui-avatars.com/api/?name=Dédé+Prisca+KELENSI&background=random', roleId: 'member', descendance: 'KELENSI', contributionTypeIds: ['cot-annuelle'] },
    { id: 19, name: 'Kokoè Jacqueline KELENSI', email: 'kokoe.kelensi@kelensiconnect.com', phone: '92 39 40 41', joinDate: '2023-05-10', birthDate: '1970-05-12', status: 'Actif', avatar: 'https://ui-avatars.com/api/?name=Kokoè+Jacqueline+KELENSI&background=random', roleId: 'member', descendance: 'KELENSI', contributionTypeIds: ['cot-annuelle'] },
    { id: 20, name: 'Adakou Audrey KELENSI', email: 'adakou.audrey.kelensi@kelensiconnect.com', phone: '93 42 43 44', joinDate: '2021-03-15', birthDate: '1994-04-18', status: 'Actif', avatar: 'https://ui-avatars.com/api/?name=Adakou+Audrey+KELENSI&background=random', roleId: 'member', descendance: 'KELENSI', contributionTypeIds: ['cot-annuelle'] },
    { id: 21, name: 'Ayélé Lagos KELENSI', email: 'ayele.kelensi@kelensiconnect.com', phone: '99 45 46 47', joinDate: '2022-09-05', birthDate: '1986-09-09', status: 'Inactif', avatar: 'https://ui-avatars.com/api/?name=Ayélé+Lagos+KELENSI&background=random', roleId: 'member', descendance: 'KELENSI', contributionTypeIds: [] },
    ...
    { id: 23, name: 'Ayoko Popo KELENSI', email: 'ayoko.popo.kelensi@kelensiconnect.com', phone: '97 51 52 53', joinDate: '2020-01-01', birthDate: '1984-06-28', status: 'Actif', avatar: 'https://ui-avatars.com/api/?name=Ayoko+Popo+KELENSI&background=random', roleId: 'member', descendance: 'KELENSI', contributionTypeIds: ['cot-annuelle'] },
    { id: 24, name: 'Ayoko Liliane KELENSI', email: 'ayoko.liliane.kelensi@kelensiconnect.com', phone: '91 54 55 56', joinDate: '2022-03-15', birthDate: '1996-07-19', status: 'Actif', avatar: 'https://ui-avatars.com/api/?name=Ayoko+Liliane+KELENSI&background=random', roleId: 'member', descendance: 'KELENSI', contributionTypeIds: ['cot-annuelle'] },
    { id: 25, name: 'Messan Gentil KELENSI', email: 'messan.gentil.kelensi@kelensiconnect.com', phone: '98 57 58 59', joinDate: '2021-11-20', birthDate: '1989-10-10', status: 'Actif', avatar: 'https://ui-avatars.com/api/?name=Messan+Gentil+KELENSI&background=random', roleId: 'member', descendance: 'KELENSI', contributionTypeIds: ['cot-annuelle', 'projet-ecole'] },
];
